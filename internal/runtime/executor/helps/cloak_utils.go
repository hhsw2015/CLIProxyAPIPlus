...
// ShouldCloak decides whether a request should be cloaked based on config mode
// and client User-Agent. Fork-only helper preserved across the upstream refactor.
