...
func GetCodexFreeModels() []*ModelInfo {
	...
	models = appendMissingModelsByID(models, codexFreeCompatibilityBackfillIDs, data.CodexPlus, data.CodexTeam, data.CodexPro)
...
func WithCodexBuiltins(models []*ModelInfo) []*ModelInfo {
	return upsertModelInfos(models, codexBuiltinImageModelInfo(), codexBuiltinImage15ModelInfo())
}
