...
func TestThinkingE2EMatrix_Suffix(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 88a: Gemini-CLI to Antigravity, budget 8192 → passthrough thinkingBudget
		{
			name:            "88a",
			from:            "gemini-cli",
			to:              "antigravity",
		...
		// Case 89a: Gemini-CLI to Antigravity, budget 64000 → clamped to Max
		{
			name:            "89a",
			from:            "gemini-cli",
			to:              "antigravity",
		...
		// Gemini Family Cross-Channel Consistency (Cases 88-95)
...
func TestThinkingE2EMatrix_Body(t *testing.T) {
	...
	cases := []thinkingTestCase{
		...
		// Case 88a: Gemini-CLI to Antigravity, thinkingBudget=8192 → passthrough
		{
			name:            "88a",
			from:            "gemini-cli",
			to:              "antigravity",
		...
		// Case 89a: Gemini-CLI to Antigravity, thinkingBudget=64000 → exceeds Max error
		{
			name:        "89a",
			from:        "gemini-cli",
			to:          "antigravity",
